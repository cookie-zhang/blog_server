...
const aa =  async function(req:any, data:any):Boolean{
  return bcrypt.compare(req.pass, data.pass, async (err:boolean, res:boolean) => {
...
class userController {
  ...
  static async login(ctx: any) {
    ...
    try {
      ...
      // const bo = await  bcrypt.compare(req.pass, data.pass, async (err:boolean, res:boolean) => {
      //   if (req.name == data.name && res) {
      //     console.log(1)
      //     return true
      //   }
